install_oracle_libraries(){
  ...
  cd $build_dir/oracle
  local basic_download_url="https://github.com/sarielda/myoracle/raw/master/instantclient-basic-linux.x64-12.1.0.2.0.zip"
  local sdk_download_url="https://github.com/sarielda/myoracle/raw/master/instantclient-sdk-linux.x64-12.1.0.2.0.zip"
